...
export default class MyApp extends React.Component {
    render() {
        ...
        const onCancel = (data) => {
            ...
            axios.post('http://127.0.0.1:8000/api/order/', {product:object.id,user:"thomassini",total:total}).then(res=>console.log(res)).catch(err=>console.log(err.response));
